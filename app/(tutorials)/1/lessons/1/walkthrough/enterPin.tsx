...
const KeypadButton: React.FC<KeypadButtonProps> = ({
  ...
  >
    {value === "backspace" ? (
      ...
      (currentStep == 4 ? <Text style={{backgroundColor: "#fff", padding: 8, zIndex:99999}}>      <CircleCheck size={32} color="#000000ff" />
</Text>:       <CircleCheck size={32} color="#000000ff" />
)
    ) : (
...
export default function PaymentPinScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* --- Keypad --- */}
      <View style={[currentStep == 3 && styles.highlightedItem , currentStep == 4 && styles.highlightedItem2]}>
        <Keypad onKeyPress={handleKeyPress} pin={pin} currentStep={currentStep}/>
      </View>
