...
export default function SendMoney() {
  ...
  const handleSearch = (text: string) => {
    ...
    if(text.toLowerCase() === "vivek" && filtered.length == 1 && filtered[0].id == 1) setCurrentStep(currentStep + 1);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Search Bar */}
      <View style={[styles.searchContainer, (currentStep == 1 || currentStep == 2 || currentStep == 3) && styles.highlightedItem]}>
      ...
      {/* Payments List */}
      <ScrollView
        style={[styles.paymentsList, (currentStep == 0 || currentStep == 4) && styles.highlightContainer]}
      ...
      >
        {filteredPayments.length > 0
          ? filteredPayments.map((payment) => (
              <TouchableOpacity
                key={payment.id}
                style={[styles.paymentItem, (currentStep == 0 || currentStep == 4) && styles.highlightedItem2]}
                onPress={() =>{
                  if(currentStep == 4)
                  router.push({
