...
const yourLessonsData: Tutorial[] = [
  { id: "yl1", title: "Web Development Basics", lessons: 5 , image: require("../../assets/amazon.png"), status: "Ongoing"},
  { id: "yl2", title: "Data Structures 101", lessons: 3,  image: require("../../assets/flipkart.png"), status: "Ongoing"},
  { id: "yl3", title: "Mobile App Design", lessons: 8,  image:  require("../../assets/uber.png"), status: "Ongoing"},
  { id: "yl4", title: "Advanced React Native", lessons: 2,  image: require("../../assets/whatsapp.png"), status: "Ongoing"},
];
